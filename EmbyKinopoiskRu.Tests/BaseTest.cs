...
public abstract class BaseTest
{
    ...
    protected BaseTest(NLog.Logger logger)
    {
        _logger = logger;
    ...
    protected static void VerifyMovie326(Movie movie)
    {
        ...
        movie.RemoteTrailers.Should().HaveCountGreaterOrEqualTo(4);
    ...
    protected static void VerifyMovie689(Movie movie)
    {
        ...
        movie.RemoteTrailers.Should().HaveCountGreaterOrEqualTo(7);
