...
public class KpLocalMetadataTest : BaseTest
{
    ...
    public async void KpLocalMetadata_WithNameOnly_MultiResult()
    {
        ...
        movie.GetProviderId(MetadataProviders.Tmdb).Should().Be("11886", "TMDB id of the requested item");
        movie.RemoteTrailers.Length.Should().BeGreaterThanOrEqualTo(6, "the movie has RemoteTrailers");
        movie.Size.Should().Be(83, "this is movie Size");
        movie.SortName.Should().Be(movie.Name, "SortName should be equal to Name");
        movie.Studios.Length.Should().Be(2, "the movie has Studios");
    ...
    public async void KpLocalMetadata_WithNameYearAndAddToExistingCollection()
    {
        ...
        movie.Collections[0].Id.Should().Be(201L, "this is an id of a new collection");
        movie.CommunityRating.Should().BeGreaterThan(8, "such value received from API");
        ...
        movie.GetProviderId(MetadataProviders.Tmdb).Should().Be("671", "TMDB id of the requested item");
        movie.RemoteTrailers.Length.Should().BeGreaterThanOrEqualTo(20, "the movie has RemoteTrailers");
        movie.Size.Should().Be(152, "this is movie Size");
        movie.SortName.Should().Be(movie.Name, "SortName should be equal to Name");
        movie.Studios.Length.Should().Be(3, "the movie has Studios");
