...
public class KpSeriesProviderTest : BaseTest
{
    ...
    public async void KpSeriesProvider_GetMetadata_Provider_Kp()
    {
        ...
        Assert.Equal(DateTime.Parse("2007-01-01T00:00:00.0000000+02:00", DateTimeFormatInfo.InvariantInfo), series.EndDate);
        ...
        Assert.Equal(DateTime.Parse("2007-04-01T00:00:00.0000000+00:00", DateTimeFormatInfo.InvariantInfo), series.PremiereDate);
